...
const userB = { username: "fizz", password: "buzz", email: "testing@test.com" };
const userC = {
  username: "foo",
  password: "buzz",
...
describe("server.js", () => {
  ...
  describe("posts endpoint", () => {
    describe("[GET] /api/posts", () => {
      ...
      it("responds with the posts on valid token", async () => {
        const {
          body: { token },
        ...
        expect(JSON.stringify(res.body)).toEqual(expect.stringMatching(""));
      }, 500);
    });
  });
});
